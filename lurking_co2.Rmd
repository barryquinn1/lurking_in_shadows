...
library(car)
library(Matching)
load("~/Dropbox/Research/Working Papers/ClimatePolicy/dat_anal.RData")
...
lm(regY~TRADEtoGDP+URBAN+Setter+Yr,data=df_anal) %>%
  ...
  footnote(general="This table shows the marginal effects from the z coefficients in equation (1) by exploiting statistical procedure first outlined in Kuosmenan & Johnson (2015).") %>%
